...
import 'package:calculatricedevoir/controller/calculate_controller.dart';
import 'package:calculatricedevoir/controller/theme_controller.dart';
import 'package:calculatricedevoir/utils/colors.dart';
import 'package:calculatricedevoir/widget/button.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Container(
              decoration: BoxDecoration(
                color: Colors.blue, // Couleur pour les résultats
          ...
          Padding(
            ...
            child: Container(
              decoration: BoxDecoration(
                color: Colors.blue, // Couleur pour les entrées
                borderRadius: BorderRadius.circular(10),
              ),
              padding: const EdgeInsets.all(10),
